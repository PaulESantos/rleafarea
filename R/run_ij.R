...
#' second column. Note that `run_ij` does not count the number of leaves in 
...
#' edges of images are often shaded, which can affect image analysis (i.e., 
#' ImageJ may recognize the shaded area as leaf area). The edges of images can 
#' be removed by specifying the number of pixels (default = 0).
...
#' @return If you choose log= T, the `run_ij` function also returns a list of 
